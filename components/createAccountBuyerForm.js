    ...
    render() {
        ...
        return (
            <ScrollView style={{ padding: wp('7') }}>
                ...
                <TouchableOpacity disabled={!this.state.firstName || !this.state.lastName || !this.state.email || !this.state.phone||loading} style={!this.state.firstName || !this.state.lastName || !this.state.email || !this.state.phone ? styles.buttonDisabled : styles.buttonEnabled} onPress={() => this.onContinue()}>
